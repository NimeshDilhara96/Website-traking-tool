        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">Testing Dashboard</p>
            </div>
          </div>
        </div>
        ...
        <header className="px-6 py-4 bg-white border-b border-gray-200">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center justify-center w-10 h-10 font-semibold text-white rounded-full shadow-lg bg-linear-to-br from-blue-500 to-purple-600">
                <span>U</span>
              </div>
            </div>
          </div>
          ...
          {selectedWebsite ? (
            ...
            <div className="flex items-center justify-center h-full">
              <div className="p-12 text-center">
                <div className="flex items-center justify-center w-24 h-24 mx-auto mb-6 rounded-full bg-linear-to-br from-blue-100 to-purple-100">
                  <svg className="w-12 h-12 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                  </svg>
                </div>
                <h3 className="mb-2 text-2xl font-semibold text-gray-900">Welcome to Analytics Dashboard</h3>
                <p className="max-w-md mx-auto text-gray-500">Select a website from the sidebar to view detailed analytics, visitor insights, and performance metrics.</p>
              </div>
            </div>
          )}
        </main>
